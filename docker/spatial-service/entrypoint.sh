#!/bin/bash
# Auto-generated entrypoint for spatial_service
...
SERVICE_USER="spatial_service"
APP_ARTIFACT="spatial-service"
DEBUG_MODE="${DEBUG_ENTRYPOINT:-0}"

echo "🚀 Starting spatial_service as user: ${SERVICE_USER}"
