#!/bin/bash
# Auto-generated entrypoint for biocache_service
...
SERVICE_USER="biocache_service"
APP_ARTIFACT="biocache-service"
DEBUG_MODE="${DEBUG_ENTRYPOINT:-0}"

echo "🚀 Starting biocache_service as user: ${SERVICE_USER}"
